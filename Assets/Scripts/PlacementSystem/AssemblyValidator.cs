...
public class AssemblyValidator
{
    ...
    private static readonly WaterwheelComponent[] _correctOrder = 
    {
        ...
        WaterwheelComponent.InnerLongLink,
        WaterwheelComponent.InnerShortLink,
        WaterwheelComponent.OuterLongLink,
        WaterwheelComponent.OuterShortLink,
        WaterwheelComponent.TailLongLink,
        WaterwheelComponent.TailShortLink,
        ...
        WaterwheelComponent.TungOilCoating
    };
