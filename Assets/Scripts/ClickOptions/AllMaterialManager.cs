...
public class AllMaterialManager : MonoBehaviour
{
    ...
    private int requiredMainRib = 1;                // 主辐条达标数量
    private int requiredLink = 1;                     // 连杆达标数量
    private int requiredHorizontalCrossbar = 1;      // 横杠达标数量
    private int requiredPaddle = 1;                   // 刮板达标数量
    private int requiredWaterwheelSupport = 1;       // 水车支架达标数量
    private int requiredInclinedBambooTube = 1;      // 斜装竹筒达标数量
